...
- Identify and track project risks (timeline, scope, technical, relationship) and escalate before they become client-facing problems.

## KEY DELIVERABLES

- Client onboarding and requirements documents.
- Project plans and delivery timelines.
- Status updates (internal and client-facing).
- Risk logs.
- Client history records (decisions, approvals, change requests).
...
- A client requests a **scope, timeline, or pricing change** beyond the original agreement (CEO approval required for client commitments and pricing changes).
- A project risk threatens the relationship, the deadline, or GrowForge's reputation.
- A delivery department reports it cannot meet a commitment already made to the client.
- A client dispute or dissatisfaction arises that could affect retention or reputation.
- QA identifies a defect that was already represented to the client as complete.
- Authoritative client history is missing or contradictory — state this as UNKNOWN rather than reconstructing it from assumption.
