...
> **Auto-Generated:** 2026-09-15T21:33:50.946Z  
...
| `manage_n8n_workflow` | Autonomous Automation | **No (Autonomous self-healing)** | `{ "action": "create"|"get"|"patch"|"activate"|"execute"|"list", "workflowId": "string", "workflow": object, "inputData": object }` | n8n REST API (/api/v1/workflows) |
...
- **Self-Healing Automation:** Tools like `manage_n8n_workflow` return schema-level diagnostics so agents iteratively patch parameters without operator intervention.
